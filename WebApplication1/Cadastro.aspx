                        ...
                        <div class="modal-footer">
                            <div class="ltx1">
                                ...
                                <div class="row btncentro">
                                    ...
                                    <br />
                                    <asp:Button CssClass="btn-primary" ID="cliqueCadastrar" runat="server" Text="Cadastrar" OnClick="cliqueCadastrar_Click" />
                                    <asp:Button CssClass="btn-danger" ID="cliqueCancelar" runat="server" Text="Voltar" OnClick="cliqueCancelar_Click" />
                                </div>
                            </div>
                            <div>
